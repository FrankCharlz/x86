...
.code
    ...
    extrn readint:proc, readstring:proc, writechar:proc
	...
	main proc
		...
		call print_or_clear ; start by displaying 
	...
	delay proc
		...
		int 16h
		jz no_key_pressed
		call writechar ; diplay pressed key
		call writechar ; diplay pressed key
		call writechar ; diplay pressed key
		call writechar ; diplay pressed key
		call writechar ; diplay pressed key
		; exit the program cause key is pressed
		mov ah, 4ch;
		int 21h
		
		
		no_key_pressed: ; continue counting
